...
public class Queries {
	...
	public static final String FINDBYTOPICQUERY = "select q.questionId,q.topic,q.question,q.optionOne,q.optionTwo,q.optionThree,q.optionFour,a.answerId,a.answerValue from question q inner join answer a on q.answerId=a.answerId where q.topic=?";
